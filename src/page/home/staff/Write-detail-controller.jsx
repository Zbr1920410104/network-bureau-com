...
// 样式
import { Icon, Form, Row, Input, Col, Select, DatePicker, Button } from 'antd';
const { Option } = Select,
  { TextArea } = Input;
    ...
    <div className='write-detail-box'>
      ...
      <div className='write-form-box'>
        <Form>
          ...
          <Row>
            <Col span={24} style={{ textAlign: 'right' }} key='20'>
              <Button
                type='primary'
                htmlType='submit'
                onClick={() => {
              ...
              >
                {pageChange ? (
                  <Icon type='left' className='link-icon' />
                ) : (
                  <Icon type='right' className='link-icon' />
                )}
                {pageChange ? <span>上一页</span> : <span>下一页</span>}
              </Button>
            </Col>
          </Row>
        </Form>
